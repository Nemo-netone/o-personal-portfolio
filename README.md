...
项目资料已按各仓库最新 README、稳定 Pages 地址和线上页面标题完成同步。当前 1-20 均已恢复原站界面，并完成核心登录、列表与 CRUD 验证；作品集统一标记为“原站已恢复”，不再保留旧统一演示壳或“恢复推进中”的状态。

主题映射已经复核：第 12 项为美妆商城，第 15 项为动漫论坛，第 11 项为瑞牧生猪养殖信息管理系统。
